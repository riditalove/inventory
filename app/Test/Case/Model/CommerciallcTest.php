<?php
App::uses('Commerciallc', 'Model');

/**
 * Commerciallc Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommerciallcTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commerciallc = ClassRegistry::init('Commerciallc');
	}
