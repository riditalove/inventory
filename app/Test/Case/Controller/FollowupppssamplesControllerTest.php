<?php
App::uses('FollowupppssamplesController', 'Controller');

/**
 * FollowupppssamplesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupppssamplesControllerTest extends ControllerTestCase {
