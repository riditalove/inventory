<?php
App::uses('Production2ndeyelet', 'Model');

/**
 * Production2ndeyelet Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndeyeletTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndeyelet = ClassRegistry::init('Production2ndeyelet');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndeyelet);
