<?php
App::uses('Commercialshipmode', 'Model');

/**
 * Commercialshipmode Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialshipmodeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialshipmode = ClassRegistry::init('Commercialshipmode');
	}
