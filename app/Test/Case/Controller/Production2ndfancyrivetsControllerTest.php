<?php
App::uses('Production2ndfancyrivetsController', 'Controller');

/**
 * Production2ndfancyrivetsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndfancyrivetsControllerTest extends ControllerTestCase {
