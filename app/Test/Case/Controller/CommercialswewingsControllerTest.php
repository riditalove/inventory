<?php
App::uses('CommercialswewingsController', 'Controller');

/**
 * CommercialswewingsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialswewingsControllerTest extends ControllerTestCase {
