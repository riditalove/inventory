<?php
App::uses('Followuppocketingydce', 'Model');

/**
 * Followuppocketingydce Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowuppocketingydceTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followuppocketingydce = ClassRegistry::init('Followuppocketingydce');
	}
 ...
 */
	public function tearDown() {
		unset($this->Followuppocketingydce);
