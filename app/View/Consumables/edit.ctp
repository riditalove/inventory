    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo __('Consumable'); ?></li>
            </ol>
        </div>
        <div class="col-md-6 col-4 align-self-center">
            <?php echo $this->Html->link('<i class="fa fa-list-ul"></i> Consumable List', array('action' => 'index'), array('class' => 'btn pull-right btn-success', 'escape' => false)); ?>        </div>
    </div>

    <div class="row">
        <div class="col-md-10">
            <div class="card card-body">
                <h3 class="box-title m-b-0"><?php echo __('Add Consumable'); ?></h3>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        echo $this->Form->input('consumable_name');
                    ...
                    <div class="col-md-6">
                        ...
                        echo $this->Form->input('user_id',array('label'=>'Select Employee'));
                        ?>
                    </div>
                </div>
