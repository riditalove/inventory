<?php
App::uses('Test1stgarment', 'Model');

/**
 * Test1stgarment Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Test1stgarmentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Test1stgarment = ClassRegistry::init('Test1stgarment');
	}
