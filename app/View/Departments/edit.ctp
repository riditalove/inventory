    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-body">
                <h3 class="box-title m-b-0">Edit Department</h3>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        echo $this->Form->input('company_id', array('label' => false, 'empty' => 'Please Select'));
                        ?>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <?php echo $this->Form->input('color', array('class' => 'gradient-colorpicker', 'value' => $this->request->data['Department']['color_code'], 'required' => true)); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <?php echo $this->Form->input('level', array('type' => 'number', 'label' => false)); ?>
                    </div>
                </div>
                <div class="form-group row">
