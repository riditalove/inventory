<?php
App::uses('Commercialproductionpermission', 'Model');

/**
 * Commercialproductionpermission Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialproductionpermissionTest extends CakeTestCase {
 ...
 */
	public $fixtures = array(
		'app.commercialproductionpermission',
		'app.production',
		'app.customer',
		'app.country',
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialproductionpermission = ClassRegistry::init('Commercialproductionpermission');
	}
 ...
 */
	public function tearDown() {
		unset($this->Commercialproductionpermission);
