<?php
App::uses('Followupprint', 'Model');

/**
 * Followupprint Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupprintTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupprint = ClassRegistry::init('Followupprint');
	}
