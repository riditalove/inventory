<?php
App::uses('Validation2ndprotosamplesController', 'Controller');

/**
 * Validation2ndprotosamplesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Validation2ndprotosamplesControllerTest extends ControllerTestCase {
