<?php
App::uses('Production1stfancyrivetsController', 'Controller');

/**
 * Production1stfancyrivetsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stfancyrivetsControllerTest extends ControllerTestCase {
