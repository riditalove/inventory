<?php
App::uses('Test1stfabric', 'Model');

/**
 * Test1stfabric Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Test1stfabricTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Test1stfabric = ClassRegistry::init('Test1stfabric');
	}
