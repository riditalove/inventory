<?php
App::uses('Production1stprint', 'Model');

/**
 * Production1stprint Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stprintTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stprint = ClassRegistry::init('Production1stprint');
	}
