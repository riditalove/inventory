<?php
App::uses('Production1stsmse', 'Model');

/**
 * Production1stsmse Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stsmseTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stsmse = ClassRegistry::init('Production1stsmse');
	}
