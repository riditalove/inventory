<?php
App::uses('Production2ndbuttonsController', 'Controller');

/**
 * Production2ndbuttonsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndbuttonsControllerTest extends ControllerTestCase {
