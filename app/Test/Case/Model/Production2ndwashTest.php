<?php
App::uses('Production2ndwash', 'Model');

/**
 * Production2ndwash Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndwashTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndwash = ClassRegistry::init('Production2ndwash');
	}
