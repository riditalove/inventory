<?php
App::uses('Followuppocketingaope', 'Model');

/**
 * Followuppocketingaope Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowuppocketingaopeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followuppocketingaope = ClassRegistry::init('Followuppocketingaope');
	}
 ...
 */
	public function tearDown() {
		unset($this->Followuppocketingaope);
