<?php
App::uses('Production2ndtape', 'Model');

/**
 * Production2ndtape Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndtapeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndtape = ClassRegistry::init('Production2ndtape');
	}
