<?php
App::uses('Production1stfancyrivet', 'Model');

/**
 * Production1stfancyrivet Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stfancyrivetTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stfancyrivet = ClassRegistry::init('Production1stfancyrivet');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stfancyrivet);
