<?php
App::uses('Followupeyelet', 'Model');

/**
 * Followupeyelet Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupeyeletTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupeyelet = ClassRegistry::init('Followupeyelet');
	}
