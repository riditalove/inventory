<?php
App::uses('Followupwash', 'Model');

/**
 * Followupwash Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupwashTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupwash = ClassRegistry::init('Followupwash');
	}
