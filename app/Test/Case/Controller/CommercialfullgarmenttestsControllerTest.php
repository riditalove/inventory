<?php
App::uses('CommercialfullgarmenttestsController', 'Controller');

/**
 * CommercialfullgarmenttestsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialfullgarmenttestsControllerTest extends ControllerTestCase {
