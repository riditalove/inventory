<?php
App::uses('Production1stproto', 'Model');

/**
 * Production1stproto Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stprotoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stproto = ClassRegistry::init('Production1stproto');
	}
