<?php
App::uses('Followupjacron', 'Model');

/**
 * Followupjacron Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupjacronTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupjacron = ClassRegistry::init('Followupjacron');
	}
