<?php
App::uses('Production2ndembroideriesController', 'Controller');

/**
 * Production2ndembroideriesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndembroideriesControllerTest extends ControllerTestCase {
