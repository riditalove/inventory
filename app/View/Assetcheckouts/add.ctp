    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo __('Asset Check-in/out'); ?></li>
            </ol>
        </div>
        <div class="col-md-6 col-4 align-self-center">
            <?php echo $this->Html->link('<i class="fa fa-list-ul"></i> Asset Check-in/out List', array('action' => 'index'), array('class' => 'btn pull-right btn-success', 'escape' => false)); ?>        </div>
    </div>

    <div class="row">
        <div class="col-md-7">
            <div class="card card-body">
                <h3 class="box-title m-b-0"><?php echo __('Asset Check-in/out'); ?></h3>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <table class="table text-nowrap">
                            <tr><td>Asset Name</td><td><?php echo $assets['Asset']['name']; ?></td></tr>
                            <tr><td>Serial No.</td><td><?php echo $assets['Asset']['serial_no']; ?></td></tr>
                            <?php if (!empty($this->request->data['Assetcheckout']['user_id'])) { ?>
                        ...
                        if (empty($this->request->data['Assetcheckout']['user_id'])) {
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#Assetrecheckid').css('display', 'none');
    });

    function getstatus(id) {
        if (id == 2) {
            $('#Assetrecheckid').css('display', 'block');
        } else {
            $('#Assetrecheckid').css('display', 'none');
        }
    }
