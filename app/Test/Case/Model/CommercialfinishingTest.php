<?php
App::uses('Commercialfinishing', 'Model');

/**
 * Commercialfinishing Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialfinishingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialfinishing = ClassRegistry::init('Commercialfinishing');
	}
 ...
 */
	public function tearDown() {
		unset($this->Commercialfinishing);
