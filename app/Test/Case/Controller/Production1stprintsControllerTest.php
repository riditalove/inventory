<?php
App::uses('Production1stprintsController', 'Controller');

/**
 * Production1stprintsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stprintsControllerTest extends ControllerTestCase {
