<?php
App::uses('Production1stpocketinglabdip', 'Model');

/**
 * Production1stpocketinglabdip Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stpocketinglabdipTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stpocketinglabdip = ClassRegistry::init('Production1stpocketinglabdip');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stpocketinglabdip);
