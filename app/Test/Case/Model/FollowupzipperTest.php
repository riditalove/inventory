<?php
App::uses('Followupzipper', 'Model');

/**
 * Followupzipper Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupzipperTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupzipper = ClassRegistry::init('Followupzipper');
	}
