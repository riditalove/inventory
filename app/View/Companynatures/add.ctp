    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add Company Nature</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-body">
                <h3 class="box-title m-b-0">Add Company Nature</h3>
                <p class="text-muted m-b-30 font-13"> </p>
                <?php echo $this->Form->create('Companynature',array('class'=>'form-horizontal'));?>
