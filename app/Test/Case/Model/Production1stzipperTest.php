<?php
App::uses('Production1stzipper', 'Model');

/**
 * Production1stzipper Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stzipperTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stzipper = ClassRegistry::init('Production1stzipper');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stzipper);
