<?php
App::uses('Commercialwashing', 'Model');

/**
 * Commercialwashing Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialwashingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialwashing = ClassRegistry::init('Commercialwashing');
	}
