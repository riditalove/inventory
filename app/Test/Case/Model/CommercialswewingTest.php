<?php
App::uses('Commercialswewing', 'Model');

/**
 * Commercialswewing Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialswewingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialswewing = ClassRegistry::init('Commercialswewing');
	}
