<?php
App::uses('Followupppssample', 'Model');

/**
 * Followupppssample Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupppssampleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupppssample = ClassRegistry::init('Followupppssample');
	}
