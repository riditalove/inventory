<?php
App::uses('ProductionwarehousesamplesController', 'Controller');

/**
 * ProductionwarehousesamplesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class ProductionwarehousesamplesControllerTest extends ControllerTestCase {
