<?php
App::uses('ProductionmachinerydetailsController', 'Controller');

/**
 * ProductionmachinerydetailsController Test Case
 */
class ProductionmachinerydetailsControllerTest extends ControllerTestCase {
