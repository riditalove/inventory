<?php
App::uses('Factorysupplier', 'Model');

/**
 * Factorysupplier Test Case
 */
class FactorysupplierTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Factorysupplier = ClassRegistry::init('Factorysupplier');
	}
