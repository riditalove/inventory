<?php
App::uses('Production1sttape', 'Model');

/**
 * Production1sttape Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1sttapeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1sttape = ClassRegistry::init('Production1sttape');
	}
