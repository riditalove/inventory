<?php
App::uses('Production2ndcarelablesController', 'Controller');

/**
 * Production2ndcarelablesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndcarelablesControllerTest extends ControllerTestCase {
