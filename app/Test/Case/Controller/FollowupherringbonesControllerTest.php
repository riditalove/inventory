<?php
App::uses('FollowupherringbonesController', 'Controller');

/**
 * FollowupherringbonesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupherringbonesControllerTest extends ControllerTestCase {
