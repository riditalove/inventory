<?php
App::uses('CommercialfinishingsController', 'Controller');

/**
 * CommercialfinishingsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialfinishingsControllerTest extends ControllerTestCase {
