<?php
App::uses('Commercialprinting', 'Model');

/**
 * Commercialprinting Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialprintingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialprinting = ClassRegistry::init('Commercialprinting');
	}
