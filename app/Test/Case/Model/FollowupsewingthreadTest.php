<?php
App::uses('Followupsewingthread', 'Model');

/**
 * Followupsewingthread Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupsewingthreadTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupsewingthread = ClassRegistry::init('Followupsewingthread');
	}
 ...
 */
	public function tearDown() {
		unset($this->Followupsewingthread);
