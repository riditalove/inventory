<?php
App::uses('FollowupcarelablesController', 'Controller');

/**
 * FollowupcarelablesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupcarelablesControllerTest extends ControllerTestCase {
