<?php
App::uses('Production2ndzipper', 'Model');

/**
 * Production2ndzipper Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndzipperTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndzipper = ClassRegistry::init('Production2ndzipper');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndzipper);
