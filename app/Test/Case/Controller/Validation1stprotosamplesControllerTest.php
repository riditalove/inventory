<?php
App::uses('Validation1stprotosamplesController', 'Controller');

/**
 * Validation1stprotosamplesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Validation1stprotosamplesControllerTest extends ControllerTestCase {
