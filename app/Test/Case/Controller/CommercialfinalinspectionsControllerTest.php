<?php
App::uses('CommercialfinalinspectionsController', 'Controller');

/**
 * CommercialfinalinspectionsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialfinalinspectionsControllerTest extends ControllerTestCase {
