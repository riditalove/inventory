<?php
App::uses('Commercialsewingiteminhousestatus', 'Model');

/**
 * Commercialsewingiteminhousestatus Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialsewingiteminhousestatusTest extends CakeTestCase {
 ...
 */
	public $fixtures = array(
		'app.commercialsewingiteminhousestatus',
		'app.production',
		'app.customer',
		'app.country',
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialsewingiteminhousestatus = ClassRegistry::init('Commercialsewingiteminhousestatus');
	}
 ...
 */
	public function tearDown() {
		unset($this->Commercialsewingiteminhousestatus);
