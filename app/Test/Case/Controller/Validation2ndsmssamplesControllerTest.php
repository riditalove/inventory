<?php
App::uses('Validation2ndsmssamplesController', 'Controller');

/**
 * Validation2ndsmssamplesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Validation2ndsmssamplesControllerTest extends ControllerTestCase {
