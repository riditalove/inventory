<?php
App::uses('FollowupsewingthreadsController', 'Controller');

/**
 * FollowupsewingthreadsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupsewingthreadsControllerTest extends ControllerTestCase {
