<?php
App::uses('ProducttypedetailsController', 'Controller');

/**
 * ProducttypedetailsController Test Case
 */
class ProducttypedetailsControllerTest extends ControllerTestCase {
