<?php
App::uses('Production1stppssample', 'Model');

/**
 * Production1stppssample Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stppssampleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stppssample = ClassRegistry::init('Production1stppssample');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stppssample);
