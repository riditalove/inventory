<?php
App::uses('Production2ndherringbonesController', 'Controller');

/**
 * Production2ndherringbonesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndherringbonesControllerTest extends ControllerTestCase {
