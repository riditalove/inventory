<?php
App::uses('Production1strivet', 'Model');

/**
 * Production1strivet Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1strivetTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1strivet = ClassRegistry::init('Production1strivet');
	}
