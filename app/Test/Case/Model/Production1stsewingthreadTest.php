<?php
App::uses('Production1stsewingthread', 'Model');

/**
 * Production1stsewingthread Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stsewingthreadTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stsewingthread = ClassRegistry::init('Production1stsewingthread');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stsewingthread);
