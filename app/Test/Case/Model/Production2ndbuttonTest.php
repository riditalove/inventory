<?php
App::uses('Production2ndbutton', 'Model');

/**
 * Production2ndbutton Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndbuttonTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndbutton = ClassRegistry::init('Production2ndbutton');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndbutton);
