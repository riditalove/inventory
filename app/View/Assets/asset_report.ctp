                        ...
                        <table class="table table-condensed table-bordered table-hover contact-list no-wrap">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo $this->Paginator->sort('asset_details'); ?></th>
                                    <th><?php echo $this->Paginator->sort('requestable'); ?></th>
                            ...
                            <tbody>
                                <?php foreach ($assets as $asset): ?>
                                    <tr>
                                        ...
                                        <td><?php echo h($asset['Asset']['asset_details']); ?>&nbsp;</td>
                                        <td><?php echo h($asset['Asset']['requestable']); ?>&nbsp;</td>
                                        <td><?php echo h($asset['Asset']['ext']); ?>&nbsp;</td>
