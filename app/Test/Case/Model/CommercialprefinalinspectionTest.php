<?php
App::uses('Commercialprefinalinspection', 'Model');

/**
 * Commercialprefinalinspection Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialprefinalinspectionTest extends CakeTestCase {
 ...
 */
	public $fixtures = array(
		'app.commercialprefinalinspection',
		'app.production',
		'app.customer',
		'app.country',
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialprefinalinspection = ClassRegistry::init('Commercialprefinalinspection');
	}
 ...
 */
	public function tearDown() {
		unset($this->Commercialprefinalinspection);
