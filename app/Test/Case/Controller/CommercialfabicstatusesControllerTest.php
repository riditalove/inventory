<?php
App::uses('CommercialfabicstatusesController', 'Controller');

/**
 * CommercialfabicstatusesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialfabicstatusesControllerTest extends ControllerTestCase {
