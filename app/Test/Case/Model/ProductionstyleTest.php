<?php
App::uses('Productionstyle', 'Model');

/**
 * Productionstyle Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class ProductionstyleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Productionstyle = ClassRegistry::init('Productionstyle');
	}
