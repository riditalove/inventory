<?php
App::uses('Production2ndproto', 'Model');

/**
 * Production2ndproto Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndprotoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndproto = ClassRegistry::init('Production2ndproto');
	}
