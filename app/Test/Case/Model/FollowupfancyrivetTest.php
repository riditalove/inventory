<?php
App::uses('Followupfancyrivet', 'Model');

/**
 * Followupfancyrivet Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupfancyrivetTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupfancyrivet = ClassRegistry::init('Followupfancyrivet');
	}
