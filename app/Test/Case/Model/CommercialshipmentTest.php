<?php
App::uses('Commercialshipment', 'Model');

/**
 * Commercialshipment Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialshipmentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialshipment = ClassRegistry::init('Commercialshipment');
	}
