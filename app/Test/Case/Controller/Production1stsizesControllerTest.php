<?php
App::uses('Production1stsizesController', 'Controller');

/**
 * Production1stsizesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stsizesControllerTest extends ControllerTestCase {
