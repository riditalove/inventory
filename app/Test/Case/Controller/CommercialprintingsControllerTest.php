<?php
App::uses('CommercialprintingsController', 'Controller');

/**
 * CommercialprintingsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialprintingsControllerTest extends ControllerTestCase {
