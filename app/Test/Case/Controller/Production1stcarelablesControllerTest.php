<?php
App::uses('Production1stcarelablesController', 'Controller');

/**
 * Production1stcarelablesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stcarelablesControllerTest extends ControllerTestCase {
