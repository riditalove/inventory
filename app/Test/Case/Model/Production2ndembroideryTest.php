<?php
App::uses('Production2ndembroidery', 'Model');

/**
 * Production2ndembroidery Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndembroideryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndembroidery = ClassRegistry::init('Production2ndembroidery');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndembroidery);
