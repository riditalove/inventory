<?php
App::uses('Production2ndppssamplesController', 'Controller');

/**
 * Production2ndppssamplesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndppssamplesControllerTest extends ControllerTestCase {
