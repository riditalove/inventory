<?php
App::uses('Commercialcutting', 'Model');

/**
 * Commercialcutting Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialcuttingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialcutting = ClassRegistry::init('Commercialcutting');
	}
