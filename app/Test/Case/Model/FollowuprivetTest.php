<?php
App::uses('Followuprivet', 'Model');

/**
 * Followuprivet Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowuprivetTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followuprivet = ClassRegistry::init('Followuprivet');
	}
