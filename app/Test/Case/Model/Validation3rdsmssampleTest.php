<?php
App::uses('Validation3rdsmssample', 'Model');

/**
 * Validation3rdsmssample Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Validation3rdsmssampleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Validation3rdsmssample = ClassRegistry::init('Validation3rdsmssample');
	}
 ...
 */
	public function tearDown() {
		unset($this->Validation3rdsmssample);
