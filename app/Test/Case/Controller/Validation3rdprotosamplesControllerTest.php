<?php
App::uses('Validation3rdprotosamplesController', 'Controller');

/**
 * Validation3rdprotosamplesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Validation3rdprotosamplesControllerTest extends ControllerTestCase {
