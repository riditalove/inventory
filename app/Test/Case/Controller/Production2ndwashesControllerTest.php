<?php
App::uses('Production2ndwashesController', 'Controller');

/**
 * Production2ndwashesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndwashesControllerTest extends ControllerTestCase {
