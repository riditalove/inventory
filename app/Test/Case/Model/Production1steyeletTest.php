<?php
App::uses('Production1steyelet', 'Model');

/**
 * Production1steyelet Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1steyeletTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1steyelet = ClassRegistry::init('Production1steyelet');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1steyelet);
