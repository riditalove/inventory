<?php
App::uses('Production2ndherringbone', 'Model');

/**
 * Production2ndherringbone Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndherringboneTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndherringbone = ClassRegistry::init('Production2ndherringbone');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndherringbone);
