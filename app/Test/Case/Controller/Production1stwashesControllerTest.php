<?php
App::uses('Production1stwashesController', 'Controller');

/**
 * Production1stwashesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stwashesControllerTest extends ControllerTestCase {
