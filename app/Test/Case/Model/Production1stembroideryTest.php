<?php
App::uses('Production1stembroidery', 'Model');

/**
 * Production1stembroidery Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stembroideryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stembroidery = ClassRegistry::init('Production1stembroidery');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stembroidery);
