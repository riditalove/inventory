<?php
App::uses('Validation1stsmssample', 'Model');

/**
 * Validation1stsmssample Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Validation1stsmssampleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Validation1stsmssample = ClassRegistry::init('Validation1stsmssample');
	}
 ...
 */
	public function tearDown() {
		unset($this->Validation1stsmssample);
