<?php
App::uses('CommercialembroideriesController', 'Controller');

/**
 * CommercialembroideriesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialembroideriesControllerTest extends ControllerTestCase {
