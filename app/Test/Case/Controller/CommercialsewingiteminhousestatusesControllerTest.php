<?php
App::uses('CommercialsewingiteminhousestatusesController', 'Controller');

/**
 * CommercialsewingiteminhousestatusesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialsewingiteminhousestatusesControllerTest extends ControllerTestCase {
