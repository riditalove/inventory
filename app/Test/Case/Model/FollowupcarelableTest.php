<?php
App::uses('Followupcarelable', 'Model');

/**
 * Followupcarelable Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupcarelableTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupcarelable = ClassRegistry::init('Followupcarelable');
	}
