<?php
App::uses('Production2ndpocketingaope', 'Model');

/**
 * Production2ndpocketingaope Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndpocketingaopeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndpocketingaope = ClassRegistry::init('Production2ndpocketingaope');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndpocketingaope);
