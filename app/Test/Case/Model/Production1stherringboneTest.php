<?php
App::uses('Production1stherringbone', 'Model');

/**
 * Production1stherringbone Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stherringboneTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stherringbone = ClassRegistry::init('Production1stherringbone');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stherringbone);
