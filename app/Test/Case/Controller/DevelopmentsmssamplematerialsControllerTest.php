<?php
App::uses('DevelopmentsmssamplematerialsController', 'Controller');

/**
 * DevelopmentsmssamplematerialsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class DevelopmentsmssamplematerialsControllerTest extends ControllerTestCase {
