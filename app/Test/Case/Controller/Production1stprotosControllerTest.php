<?php
App::uses('Production1stprotosController', 'Controller');

/**
 * Production1stprotosController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stprotosControllerTest extends ControllerTestCase {
