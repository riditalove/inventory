...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Asset Check-in/out</li>
            </ol>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Asset Check-in/out List</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed table-bordered table-hover contact-list no-wrap">
                            ...
                            <tbody>
                                <?php 
                                //pr($assetcheckout);
                                foreach ($assetcheckouts as $assetcheckout): ?>
                                    <tr>
                                        <td><?php echo h($assetcheckout['Assetcheckout']['id']); ?>&nbsp;</td>
                                        <td>
                                            <?php echo $this->Html->link($assetcheckout['Asset']['name'], array('controller' => 'accessories', 'action' => 'view', $assetcheckout['Asset']['id'])); ?>
                                        </td>
                                        <td>
                                            <?php echo $this->Html->link($assetcheckout['User']['name'], array('controller' => 'users', 'action' => 'view', $assetcheckout['User']['id'])); ?>
                                        </td>
                                        <td><?php echo h($assetcheckout['Assetcheckout']['checkin_date']); ?>&nbsp;</td>
                                        <td><?php echo h($assetcheckout['Assetcheckout']['checkout_date']); ?>&nbsp;</td>
                                        <td><?php 
                                         echo $pstatus[$assetcheckout['Assetcheckout']['status']];
                                        ?>&nbsp;</td>
                                        <td><?php echo h($assetcheckout['Assetcheckout']['note']); ?>&nbsp;</td>
                                        <td class="actions">
                                            <?php echo $this->Html->link(__('<i class="icon-eye" title="View"></i>'), array('action' => 'view', $assetcheckout['Assetcheckout']['id']), array('escape' => false)); ?>
                                            <?php echo $this->Form->postLink(__('<i class="icon-trash text-danger" title="Delete"></i>'), array('action' => 'delete', $assetcheckout['Assetcheckout']['id']), array('confirm' => __('Are you sure you want to delete?'), 'escape' => false)); ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
