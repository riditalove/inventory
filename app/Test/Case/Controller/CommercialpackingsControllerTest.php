<?php
App::uses('CommercialpackingsController', 'Controller');

/**
 * CommercialpackingsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialpackingsControllerTest extends ControllerTestCase {
