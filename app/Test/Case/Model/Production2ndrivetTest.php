<?php
App::uses('Production2ndrivet', 'Model');

/**
 * Production2ndrivet Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndrivetTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndrivet = ClassRegistry::init('Production2ndrivet');
	}
