<?php
App::uses('Production2ndsizesController', 'Controller');

/**
 * Production2ndsizesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndsizesControllerTest extends ControllerTestCase {
