<?php
App::uses('Production1strivetsController', 'Controller');

/**
 * Production1strivetsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1strivetsControllerTest extends ControllerTestCase {
