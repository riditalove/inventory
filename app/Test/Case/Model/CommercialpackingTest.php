<?php
App::uses('Commercialpacking', 'Model');

/**
 * Commercialpacking Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialpackingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialpacking = ClassRegistry::init('Commercialpacking');
	}
