<?php
App::uses('Validation1stprotosample', 'Model');

/**
 * Validation1stprotosample Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Validation1stprotosampleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Validation1stprotosample = ClassRegistry::init('Validation1stprotosample');
	}
 ...
 */
	public function tearDown() {
		unset($this->Validation1stprotosample);
