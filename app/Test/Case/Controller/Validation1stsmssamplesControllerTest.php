<?php
App::uses('Validation1stsmssamplesController', 'Controller');

/**
 * Validation1stsmssamplesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Validation1stsmssamplesControllerTest extends ControllerTestCase {
