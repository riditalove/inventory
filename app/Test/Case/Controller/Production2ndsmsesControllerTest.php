<?php
App::uses('Production2ndsmsesController', 'Controller');

/**
 * Production2ndsmsesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndsmsesControllerTest extends ControllerTestCase {
