<?php
App::uses('Validation2ndsmssample', 'Model');

/**
 * Validation2ndsmssample Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Validation2ndsmssampleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Validation2ndsmssample = ClassRegistry::init('Validation2ndsmssample');
	}
 ...
 */
	public function tearDown() {
		unset($this->Validation2ndsmssample);
