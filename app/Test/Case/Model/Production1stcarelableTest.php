<?php
App::uses('Production1stcarelable', 'Model');

/**
 * Production1stcarelable Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stcarelableTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stcarelable = ClassRegistry::init('Production1stcarelable');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stcarelable);
