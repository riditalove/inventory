<?php
App::uses('Production2ndjacron', 'Model');

/**
 * Production2ndjacron Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndjacronTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndjacron = ClassRegistry::init('Production2ndjacron');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndjacron);
