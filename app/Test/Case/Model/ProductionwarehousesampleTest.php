<?php
App::uses('Productionwarehousesample', 'Model');

/**
 * Productionwarehousesample Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class ProductionwarehousesampleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Productionwarehousesample = ClassRegistry::init('Productionwarehousesample');
	}
 ...
 */
	public function tearDown() {
		unset($this->Productionwarehousesample);
