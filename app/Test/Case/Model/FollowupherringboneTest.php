<?php
App::uses('Followupherringbone', 'Model');

/**
 * Followupherringbone Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupherringboneTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupherringbone = ClassRegistry::init('Followupherringbone');
	}
 ...
 */
	public function tearDown() {
		unset($this->Followupherringbone);
