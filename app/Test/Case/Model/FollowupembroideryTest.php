<?php
App::uses('Followupembroidery', 'Model');

/**
 * Followupembroidery Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupembroideryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupembroidery = ClassRegistry::init('Followupembroidery');
	}
