    ...
    <div class="row">
        <div class="col-md-10">
            <div class="card card-body">
                <h3 class="box-title m-b-0"><?php echo __('Edit License'); ?></h3>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        echo $this->Form->input('file', array('type' => 'file', 'id' => 'input-file-now-custom-2', 'data-height'=>'120','class' => 'dropify', 'label' => 'Upload Parcel Document')) . '<br>';
