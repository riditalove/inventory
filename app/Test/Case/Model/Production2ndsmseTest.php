<?php
App::uses('Production2ndsmse', 'Model');

/**
 * Production2ndsmse Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndsmseTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndsmse = ClassRegistry::init('Production2ndsmse');
	}
