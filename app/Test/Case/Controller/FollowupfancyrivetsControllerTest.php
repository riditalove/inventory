<?php
App::uses('FollowupfancyrivetsController', 'Controller');

/**
 * FollowupfancyrivetsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupfancyrivetsControllerTest extends ControllerTestCase {
