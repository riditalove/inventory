<?php
App::uses('Production1stsize', 'Model');

/**
 * Production1stsize Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stsizeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stsize = ClassRegistry::init('Production1stsize');
	}
