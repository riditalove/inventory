<?php
App::uses('Commercialfinalinspection', 'Model');

/**
 * Commercialfinalinspection Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialfinalinspectionTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialfinalinspection = ClassRegistry::init('Commercialfinalinspection');
	}
 ...
 */
	public function tearDown() {
		unset($this->Commercialfinalinspection);
