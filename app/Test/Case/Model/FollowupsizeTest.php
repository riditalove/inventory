<?php
App::uses('Followupsize', 'Model');

/**
 * Followupsize Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupsizeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupsize = ClassRegistry::init('Followupsize');
	}
