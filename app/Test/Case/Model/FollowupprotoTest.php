<?php
App::uses('Followupproto', 'Model');

/**
 * Followupproto Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupprotoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupproto = ClassRegistry::init('Followupproto');
	}
