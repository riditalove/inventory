<?php
App::uses('Production2ndpocketingydce', 'Model');

/**
 * Production2ndpocketingydce Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndpocketingydceTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndpocketingydce = ClassRegistry::init('Production2ndpocketingydce');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndpocketingydce);
