<?php
App::uses('Production2ndsize', 'Model');

/**
 * Production2ndsize Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndsizeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndsize = ClassRegistry::init('Production2ndsize');
	}
