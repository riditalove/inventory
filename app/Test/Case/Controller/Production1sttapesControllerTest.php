<?php
App::uses('Production1sttapesController', 'Controller');

/**
 * Production1sttapesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1sttapesControllerTest extends ControllerTestCase {
