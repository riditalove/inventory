<?php
App::uses('Commercialfullgarmenttest', 'Model');

/**
 * Commercialfullgarmenttest Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialfullgarmenttestTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialfullgarmenttest = ClassRegistry::init('Commercialfullgarmenttest');
	}
 ...
 */
	public function tearDown() {
		unset($this->Commercialfullgarmenttest);
