<?php
App::uses('Production2ndrivetsController', 'Controller');

/**
 * Production2ndrivetsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndrivetsControllerTest extends ControllerTestCase {
