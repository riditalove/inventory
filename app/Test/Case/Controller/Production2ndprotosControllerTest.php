<?php
App::uses('Production2ndprotosController', 'Controller');

/**
 * Production2ndprotosController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndprotosControllerTest extends ControllerTestCase {
