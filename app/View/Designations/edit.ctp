    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-body">
                <h3 class="box-title m-b-0">Edit Designation</h3>
                ...
                <?php echo $this->Form->input('color', array('class' => 'gradient-colorpicker', 'value' => $this->request->data['Designation']['color_code'], 'required' => true)); ?>
