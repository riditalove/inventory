<?php
App::uses('CommercialwashingsController', 'Controller');

/**
 * CommercialwashingsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialwashingsControllerTest extends ControllerTestCase {
