<?php
App::uses('Followuplabdip', 'Model');

/**
 * Followuplabdip Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowuplabdipTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followuplabdip = ClassRegistry::init('Followuplabdip');
	}
