<?php
App::uses('Production2ndppssample', 'Model');

/**
 * Production2ndppssample Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndppssampleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndppssample = ClassRegistry::init('Production2ndppssample');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndppssample);
