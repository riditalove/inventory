<?php
App::uses('Production2ndjacronsController', 'Controller');

/**
 * Production2ndjacronsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndjacronsControllerTest extends ControllerTestCase {
