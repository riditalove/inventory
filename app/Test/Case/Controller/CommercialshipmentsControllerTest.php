<?php
App::uses('CommercialshipmentsController', 'Controller');

/**
 * CommercialshipmentsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialshipmentsControllerTest extends ControllerTestCase {
