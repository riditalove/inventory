<?php
App::uses('CommercialppmeetingsController', 'Controller');

/**
 * CommercialppmeetingsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialppmeetingsControllerTest extends ControllerTestCase {
