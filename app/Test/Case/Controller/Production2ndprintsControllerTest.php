<?php
App::uses('Production2ndprintsController', 'Controller');

/**
 * Production2ndprintsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndprintsControllerTest extends ControllerTestCase {
