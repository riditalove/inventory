<?php
App::uses('Production2ndeyeletsController', 'Controller');

/**
 * Production2ndeyeletsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndeyeletsControllerTest extends ControllerTestCase {
