<?php
App::uses('Production1stherringbonesController', 'Controller');

/**
 * Production1stherringbonesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stherringbonesControllerTest extends ControllerTestCase {
