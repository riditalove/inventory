<?php
App::uses('Followuptape', 'Model');

/**
 * Followuptape Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowuptapeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followuptape = ClassRegistry::init('Followuptape');
	}
