<?php
App::uses('Production1stjacronsController', 'Controller');

/**
 * Production1stjacronsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stjacronsControllerTest extends ControllerTestCase {
