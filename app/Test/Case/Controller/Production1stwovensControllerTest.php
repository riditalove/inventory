<?php
App::uses('Production1stwovensController', 'Controller');

/**
 * Production1stwovensController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stwovensControllerTest extends ControllerTestCase {
