<?php
App::uses('Production2ndfancyrivet', 'Model');

/**
 * Production2ndfancyrivet Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndfancyrivetTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndfancyrivet = ClassRegistry::init('Production2ndfancyrivet');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndfancyrivet);
