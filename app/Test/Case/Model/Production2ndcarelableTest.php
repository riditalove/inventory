<?php
App::uses('Production2ndcarelable', 'Model');

/**
 * Production2ndcarelable Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndcarelableTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndcarelable = ClassRegistry::init('Production2ndcarelable');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndcarelable);
