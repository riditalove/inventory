<?php
App::uses('Commercialppmeeting', 'Model');

/**
 * Commercialppmeeting Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialppmeetingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialppmeeting = ClassRegistry::init('Commercialppmeeting');
	}
 ...
 */
	public function tearDown() {
		unset($this->Commercialppmeeting);
