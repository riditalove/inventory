<?php
App::uses('Production2ndzippersController', 'Controller');

/**
 * Production2ndzippersController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndzippersControllerTest extends ControllerTestCase {
