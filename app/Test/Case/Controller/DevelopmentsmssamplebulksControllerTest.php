<?php
App::uses('DevelopmentsmssamplebulksController', 'Controller');

/**
 * DevelopmentsmssamplebulksController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class DevelopmentsmssamplebulksControllerTest extends ControllerTestCase {
