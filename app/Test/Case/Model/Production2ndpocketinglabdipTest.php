<?php
App::uses('Production2ndpocketinglabdip', 'Model');

/**
 * Production2ndpocketinglabdip Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndpocketinglabdipTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndpocketinglabdip = ClassRegistry::init('Production2ndpocketinglabdip');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndpocketinglabdip);
