<?php
App::uses('Followuppocketinglabdip', 'Model');

/**
 * Followuppocketinglabdip Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowuppocketinglabdipTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followuppocketinglabdip = ClassRegistry::init('Followuppocketinglabdip');
	}
 ...
 */
	public function tearDown() {
		unset($this->Followuppocketinglabdip);
