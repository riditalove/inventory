<?php
App::uses('Followupwoven', 'Model');

/**
 * Followupwoven Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupwovenTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupwoven = ClassRegistry::init('Followupwoven');
	}
