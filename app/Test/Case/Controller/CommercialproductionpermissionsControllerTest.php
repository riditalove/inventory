<?php
App::uses('CommercialproductionpermissionsController', 'Controller');

/**
 * CommercialproductionpermissionsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialproductionpermissionsControllerTest extends ControllerTestCase {
