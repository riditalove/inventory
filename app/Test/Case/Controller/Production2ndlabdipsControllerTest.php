<?php
App::uses('Production2ndlabdipsController', 'Controller');

/**
 * Production2ndlabdipsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndlabdipsControllerTest extends ControllerTestCase {
