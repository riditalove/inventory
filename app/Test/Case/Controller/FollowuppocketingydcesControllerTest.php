<?php
App::uses('FollowuppocketingydcesController', 'Controller');

/**
 * FollowuppocketingydcesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowuppocketingydcesControllerTest extends ControllerTestCase {
