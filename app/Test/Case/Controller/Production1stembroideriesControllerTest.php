<?php
App::uses('Production1stembroideriesController', 'Controller');

/**
 * Production1stembroideriesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stembroideriesControllerTest extends ControllerTestCase {
