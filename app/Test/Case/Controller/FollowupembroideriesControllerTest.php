<?php
App::uses('FollowupembroideriesController', 'Controller');

/**
 * FollowupembroideriesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupembroideriesControllerTest extends ControllerTestCase {
