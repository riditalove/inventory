<?php
App::uses('Production2ndprint', 'Model');

/**
 * Production2ndprint Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndprintTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndprint = ClassRegistry::init('Production2ndprint');
	}
