<?php
App::uses('Production1stjacron', 'Model');

/**
 * Production1stjacron Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stjacronTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stjacron = ClassRegistry::init('Production1stjacron');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stjacron);
