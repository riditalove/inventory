<?php
App::uses('Production2ndlabdip', 'Model');

/**
 * Production2ndlabdip Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndlabdipTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndlabdip = ClassRegistry::init('Production2ndlabdip');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production2ndlabdip);
