<?php
App::uses('Commercialfabricstatus', 'Model');

/**
 * Commercialfabricstatus Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialfabricstatusTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialfabricstatus = ClassRegistry::init('Commercialfabricstatus');
	}
 ...
 */
	public function tearDown() {
		unset($this->Commercialfabricstatus);
