<?php
App::uses('Validation3rdsmssamplesController', 'Controller');

/**
 * Validation3rdsmssamplesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Validation3rdsmssamplesControllerTest extends ControllerTestCase {
