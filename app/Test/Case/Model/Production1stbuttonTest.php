<?php
App::uses('Production1stbutton', 'Model');

/**
 * Production1stbutton Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stbuttonTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stbutton = ClassRegistry::init('Production1stbutton');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stbutton);
