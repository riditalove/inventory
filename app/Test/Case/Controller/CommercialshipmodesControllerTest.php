<?php
App::uses('CommercialshipmodesController', 'Controller');

/**
 * CommercialshipmodesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialshipmodesControllerTest extends ControllerTestCase {
