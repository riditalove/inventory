            ...
            <div class="card card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        echo $this->Form->input('companytype_id', array('label' => false));
                        ?>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <?php echo $this->Form->input('weekend', array('type' => 'select', 'multiple' => 'checkbox', 'options' => $weekdays, 'selected' => explode(',', $this->request->data['Company']['weekend']))); ?>
                    </div>
                </div>
