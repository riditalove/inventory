<?php
App::uses('DevelopmentnegotiationsController', 'Controller');

/**
 * DevelopmentnegotiationsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class DevelopmentnegotiationsControllerTest extends ControllerTestCase {
