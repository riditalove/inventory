...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">License Check-in/out</li>
            </ol>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">License Check-in/out List</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed table-bordered table-hover contact-list no-wrap">
                            ...
                            <tbody>
                                <?php 
                                //pr($licensecheckout);
                                foreach ($licensecheckouts as $licensecheckout): ?>
                                    <tr>
                                        <td><?php echo h($licensecheckout['Licensecheckout']['id']); ?>&nbsp;</td>
                                        <td>
                                            <?php echo $this->Html->link($licensecheckout['License']['name'], array('controller' => 'accessories', 'action' => 'view', $licensecheckout['License']['id'])); ?>
                                        </td>
                                        <td>
                                            <?php echo $this->Html->link($licensecheckout['User']['name'], array('controller' => 'users', 'action' => 'view', $licensecheckout['User']['id'])); ?>
                                        </td>
                                        <td><?php echo h($licensecheckout['Licensecheckout']['checkin_date']); ?>&nbsp;</td>
                                        <td><?php echo h($licensecheckout['Licensecheckout']['checkout_date']); ?>&nbsp;</td>
                                        <td><?php echo $pstatus[$licensecheckout['Licensecheckout']['status']]; ?>&nbsp;</td>
                                        <td><?php echo h($licensecheckout['Licensecheckout']['note']); ?>&nbsp;</td>
                                        <td class="actions">
                                            <?php echo $this->Html->link(__('<i class="icon-eye" title="View"></i>'), array('action' => 'view', $licensecheckout['Licensecheckout']['id']), array('escape' => false)); ?>
                                            <?php echo $this->Form->postLink(__('<i class="icon-trash text-danger" title="Delete"></i>'), array('action' => 'delete', $licensecheckout['Licensecheckout']['id']), array('confirm' => __('Are you sure you want to delete?'), 'escape' => false)); ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
