<?php
App::uses('Test3rdgarment', 'Model');

/**
 * Test3rdgarment Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Test3rdgarmentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Test3rdgarment = ClassRegistry::init('Test3rdgarment');
	}
