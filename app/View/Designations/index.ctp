                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-condensed table-bordered table-hover contact-list no-wrap">
                                <tr>
                                    ...
                                    <td><?php echo $this->Form->input('name', array('label' => false, 'style' => 'width:90%')); ?></td>
                            ...
                            <tbody>
                                ...
                                foreach ($designations as $designation): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $this->Html->link($companies[$designation['Department']['company_id']], array('controller' => 'companies', 'action' => 'view', $designation['Department']['company_id'])); ?></span>
                                        </td>
                                        <td>
                                            <span class="label" style="background:<?php echo $designation['Department']['color_code']; ?>"><?php echo $this->Html->link($designation['Department']['name'], array('controller' => 'departments', 'action' => 'view', $designation['Department']['id'])); ?></span>
                                        </td>
                                        <td><span class="label" style="background:<?php echo $designation['Designation']['color_code'];?>"><?php echo h($designation['Designation']['name']); ?></span></td>
                                        <td><?php echo h($designation['Designation']['level']); ?></td>
                                        <td><?php echo $users[$designation['Designation']['entry_by']]; ?></td>
                                        <td><?php echo $status[$designation['Designation']['status']]; ?></td>
                                        <td class="actions">
                                            <?php echo $this->Html->link(__('<i class="icon-eye" title="View"></i>'), array('action' => 'view', $designation['Designation']['id']), array('escape' => false)); ?>
                                            <?php echo $this->Html->link(__('<i class="icon-pencil7 text-success" title="Edit"></i>'), array('action' => 'edit', $designation['Designation']['id']), array('escape' => false)); ?>
                                            <?php echo $this->Form->postLink(__('<i class="icon-trash text-danger" title="Delete"></i>'), array('action' => 'delete', $designation['Designation']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $designation['Designation']['id']), 'escape' => false)); ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
