<?php
App::uses('Production1stlabdip', 'Model');

/**
 * Production1stlabdip Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stlabdipTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stlabdip = ClassRegistry::init('Production1stlabdip');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stlabdip);
