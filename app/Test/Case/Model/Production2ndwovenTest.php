<?php
App::uses('Production2ndwoven', 'Model');

/**
 * Production2ndwoven Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndwovenTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production2ndwoven = ClassRegistry::init('Production2ndwoven');
	}
