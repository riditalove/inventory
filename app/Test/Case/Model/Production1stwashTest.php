<?php
App::uses('Production1stwash', 'Model');

/**
 * Production1stwash Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stwashTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stwash = ClassRegistry::init('Production1stwash');
	}
