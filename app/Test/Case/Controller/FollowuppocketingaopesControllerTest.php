<?php
App::uses('FollowuppocketingaopesController', 'Controller');

/**
 * FollowuppocketingaopesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowuppocketingaopesControllerTest extends ControllerTestCase {
