<?php
App::uses('Commercialfabicstatus', 'Model');

/**
 * Commercialfabicstatus Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialfabicstatusTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialfabicstatus = ClassRegistry::init('Commercialfabicstatus');
	}
 ...
 */
	public function tearDown() {
		unset($this->Commercialfabicstatus);
