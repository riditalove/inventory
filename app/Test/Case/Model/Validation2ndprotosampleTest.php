<?php
App::uses('Validation2ndprotosample', 'Model');

/**
 * Validation2ndprotosample Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Validation2ndprotosampleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Validation2ndprotosample = ClassRegistry::init('Validation2ndprotosample');
	}
 ...
 */
	public function tearDown() {
		unset($this->Validation2ndprotosample);
