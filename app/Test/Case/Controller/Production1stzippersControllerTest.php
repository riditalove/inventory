<?php
App::uses('Production1stzippersController', 'Controller');

/**
 * Production1stzippersController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stzippersControllerTest extends ControllerTestCase {
