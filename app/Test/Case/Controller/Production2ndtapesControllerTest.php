<?php
App::uses('Production2ndtapesController', 'Controller');

/**
 * Production2ndtapesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production2ndtapesControllerTest extends ControllerTestCase {
