<?php
App::uses('Production1stwoven', 'Model');

/**
 * Production1stwoven Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stwovenTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stwoven = ClassRegistry::init('Production1stwoven');
	}
