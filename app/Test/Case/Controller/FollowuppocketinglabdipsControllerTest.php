<?php
App::uses('FollowuppocketinglabdipsController', 'Controller');

/**
 * FollowuppocketinglabdipsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowuppocketinglabdipsControllerTest extends ControllerTestCase {
