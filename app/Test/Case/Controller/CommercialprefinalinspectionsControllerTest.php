<?php
App::uses('CommercialprefinalinspectionsController', 'Controller');

/**
 * CommercialprefinalinspectionsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialprefinalinspectionsControllerTest extends ControllerTestCase {
