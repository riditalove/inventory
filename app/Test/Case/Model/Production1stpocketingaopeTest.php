<?php
App::uses('Production1stpocketingaope', 'Model');

/**
 * Production1stpocketingaope Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stpocketingaopeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stpocketingaope = ClassRegistry::init('Production1stpocketingaope');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stpocketingaope);
