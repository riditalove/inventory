<?php
App::uses('Production1stppssamplesController', 'Controller');

/**
 * Production1stppssamplesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stppssamplesControllerTest extends ControllerTestCase {
