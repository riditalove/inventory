<?php
App::uses('DevelopmentsmssamplepriosController', 'Controller');

/**
 * DevelopmentsmssamplepriosController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class DevelopmentsmssamplepriosControllerTest extends ControllerTestCase {
