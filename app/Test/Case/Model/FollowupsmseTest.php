<?php
App::uses('Followupsmse', 'Model');

/**
 * Followupsmse Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupsmseTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupsmse = ClassRegistry::init('Followupsmse');
	}
