                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed table-bordered table-hover contact-list no-wrap">
                            ...
                            <tbody>
                                <?php 
                                //pr($accessorycheckouts);
                                foreach ($accessorycheckouts as $accessorycheckout): ?>
                                    <tr>
                                        <td><?php echo h($accessorycheckout['Accessorycheckout']['id']); ?>&nbsp;</td>
                                        <td>
                                            <?php echo $this->Html->link($accessorycheckout['Accessory']['accessory_name'], array('controller' => 'accessories', 'action' => 'view', $accessorycheckout['Accessory']['id'])); ?>
                                        </td>
                                        <td>
                                            <?php echo $this->Html->link($accessorycheckout['User']['name'], array('controller' => 'users', 'action' => 'view', $accessorycheckout['User']['id'])); ?>
                                        </td>
                                        <td><?php echo h($accessorycheckout['Accessorycheckout']['checkin_date']); ?>&nbsp;</td>
                                        <td><?php echo h($accessorycheckout['Accessorycheckout']['checkout_date']); ?>&nbsp;</td>
                                        <td><?php 
                                         echo $pstatus[$accessorycheckout['Accessorycheckout']['status']];
                                        ?>&nbsp;</td>
                                        <td><?php echo h($accessorycheckout['Accessorycheckout']['note']); ?>&nbsp;</td>
                                        <td class="actions">
                                            <?php echo $this->Html->link(__('<i class="icon-eye" title="View"></i>'), array('action' => 'view', $accessorycheckout['Accessorycheckout']['id']), array('escape' => false)); ?>
                                            <?php echo $this->Form->postLink(__('<i class="icon-trash text-danger" title="Delete"></i>'), array('action' => 'delete', $accessorycheckout['Accessorycheckout']['id']), array('confirm' => __('Are you sure you want to delete?'), 'escape' => false)); ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
