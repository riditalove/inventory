<?php
App::uses('Production1stlabdipsController', 'Controller');

/**
 * Production1stlabdipsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stlabdipsControllerTest extends ControllerTestCase {
