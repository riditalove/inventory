<?php
App::uses('CommercialfabricstatusesController', 'Controller');

/**
 * CommercialfabricstatusesController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialfabricstatusesControllerTest extends ControllerTestCase {
