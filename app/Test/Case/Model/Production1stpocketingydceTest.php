<?php
App::uses('Production1stpocketingydce', 'Model');

/**
 * Production1stpocketingydce Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Production1stpocketingydceTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Production1stpocketingydce = ClassRegistry::init('Production1stpocketingydce');
	}
 ...
 */
	public function tearDown() {
		unset($this->Production1stpocketingydce);
