<?php
App::uses('CommercialcuttingsController', 'Controller');

/**
 * CommercialcuttingsController Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialcuttingsControllerTest extends ControllerTestCase {
