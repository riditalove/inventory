<?php
App::uses('Test2ndgarment', 'Model');

/**
 * Test2ndgarment Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class Test2ndgarmentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Test2ndgarment = ClassRegistry::init('Test2ndgarment');
	}
