<?php
App::uses('Commercialembroidery', 'Model');

/**
 * Commercialembroidery Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class CommercialembroideryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Commercialembroidery = ClassRegistry::init('Commercialembroidery');
	}
 ...
 */
	public function tearDown() {
		unset($this->Commercialembroidery);
