<?php
App::uses('Followupbutton', 'Model');

/**
 * Followupbutton Test Case
* Owner: Abdul Jalil
* http://www.softwareend.com
 */
class FollowupbuttonTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Followupbutton = ClassRegistry::init('Followupbutton');
	}
